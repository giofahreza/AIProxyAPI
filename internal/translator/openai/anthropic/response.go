// Package anthropic provides response translation functionality for OpenAI to Anthropic API.
...
func ConvertOpenAIResponseToAnthropic(_ context.Context, _ string, originalRequestRawJSON, requestRawJSON, rawJSON []byte, param *any) []string {
	if *param == nil {
...
// ConvertOpenAIResponseToAnthropicNonStream converts a non-streaming OpenAI response to a non-streaming Anthropic response.
//
// Parameters:
//   - ctx: The context for the request.
//   - modelName: The name of the model.
...
func ConvertOpenAIResponseToAnthropicNonStream(_ context.Context, _ string, originalRequestRawJSON, requestRawJSON, rawJSON []byte, _ *any) string {
...
// AnthropicTokenCount formats token count in Anthropic format
func AnthropicTokenCount(ctx context.Context, count int64) string {
