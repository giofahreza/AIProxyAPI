...
import (
	...
	"github.com/giofahreza/AIProxyAPI/v6/internal/access"
	managementHandlers "github.com/giofahreza/AIProxyAPI/v6/internal/api/handlers/management"
	"github.com/giofahreza/AIProxyAPI/v6/internal/api/middleware"
	"github.com/giofahreza/AIProxyAPI/v6/internal/api/modules"
	ampmodule "github.com/giofahreza/AIProxyAPI/v6/internal/api/modules/amp"
	...
	"github.com/giofahreza/AIProxyAPI/v6/sdk/api/handlers/claude"
	"github.com/giofahreza/AIProxyAPI/v6/sdk/api/handlers/gemini"
	"github.com/giofahreza/AIProxyAPI/v6/sdk/api/handlers/openai"
	sdkAuth "github.com/giofahreza/AIProxyAPI/v6/sdk/auth"
	"github.com/giofahreza/AIProxyAPI/v6/sdk/cliproxy/auth"
...
func (s *Server) setupRoutes() {
	...
	v1.Use(middleware.StripModelPrefix()) // Strip "{owner}/" prefix from model names
	{
