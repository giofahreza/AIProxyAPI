...
REMOTE_DIR="/home/ubuntu/CLIProxyAPI"
SERVICE_NAME="cliproxyapi.service"
LOCAL_BINARY="cliproxyapi"
...
scp -i "$SSH_KEY" "$LOCAL_BINARY" "$SERVER_USER@$SERVER_HOST:$REMOTE_DIR/cliproxyapi.new"
...
sudo systemctl status cliproxyapi.service --no-pager | head -15
